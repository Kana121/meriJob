...
<br /><br />
          ...
          <div className={style.paymentcheckbox}>
            <input type="checkbox" />
            <p>I agree to Terms and Conditions, Privacy Statement. Meri Job will automatically continue your subscription and charge the monthly membership fee to your payment method until you cancel. You may cancel your subscription at any time.</p>
          </div>
